...
function ProfileModal({setShowEdit}) {
    ...
    const handleSaveProfile = async (e) => {
        ...
        try {
            ...
            userData.append('location', full_name)
            profile_picture && userData.append('profile', profile_picture)
            cover_photo && cover_photo.append('cover', cover_photo)
  ...
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 z-110 overflow-y-scroll bg-black/50 p-4'>
            ...
            <div className='bg-white rounded-lg shadow p-6'>
                ...
                >
                    ...
                    <div>
                        ...
                        <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Plase enter your full name' onChange={(e) => setEditForm({...editForm, full_name
                             : e.target.value
                    ...
                    <div>
                        ...
                        <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Plase enter your user name' onChange={(e) => setEditForm({...editForm, username
                             : e.target.value
                    ...
                    <div>
                        ...
                        <textarea rows={3} className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Plase enter sort bio' onChange={(e) => setEditForm({...editForm, bio
                             : e.target.value
                        })} value={editForm.bio}/>
                    </div>
                    ...
                    <div>
                        ...
                        <input type='text' className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Plase enter your location' onChange={(e) => setEditForm({...editForm, location
                             : e.target.value
                    ...
                    <div className='flex justify-end space-x-3 pt-6'>
                        ...
                        <button type='submit' className='px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 hover:to-purple-700 transition rounded-lg cursor-pointer'>Save Changes</button>
